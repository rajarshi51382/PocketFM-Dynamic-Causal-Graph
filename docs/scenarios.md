...
1. Click "Castle is unsafe" 5 to 7 times.
2. Expected:
...
- Enemy approaching -> valence decreases, arousal increases.
- Peace declared -> valence increases, arousal decreases.
...
3. Expected:
   - Structured extraction and response work without crashes.
