...
- User statements are treated as direct observations with credibility 1.0.
- Negated propositions (for example, `not_castle_is_safe`) update the base belief inversely.
...
- Load episode snapshots as initial belief and relationship states.
